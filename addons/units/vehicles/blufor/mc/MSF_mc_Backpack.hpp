...
class MSF_mc_MarksmanBackpack : MSF_mc_BaseBackpack
{
	...
	class TransportMagazines {
		#include "..\..\base\Base_BackPack_Grenades.hpp"
		class _xx_20rnd_m993 { magazine = "rhsusf_20Rnd_762x51_m993_Mag"; count = 2; };
	};
};
...
class MSF_mc_PMAGBackpack : MSF_mc_BaseBackpack
{
	...
	class TransportMagazines {
		#include "..\..\base\Base_BackPack_Grenades.hpp"
		class _xx_30rnd_tan_pmag { magazine = "rhs_mag_20Rnd_SCAR_762x51_m62_tracer"; count = 3; };
	};
};
...
class MSF_mc_PMAGSupplyBackpack : MSF_mc_BaseBackpack
{
	...
	class TransportMagazines {
		#include "..\..\base\Base_BackPack_Grenades.hpp"
		class _xx_20rnd_pmag { magazine = "rhs_mag_20Rnd_SCAR_762x51_m62_tracer"; count = 12; };
	};
};
...
class MSF_mc_SniperBackpack : MSF_mc_BaseBackpack
{
	...
	class TransportMagazines {
		#include "..\..\base\Base_BackPack_Grenades.hpp"
		class _xx_10rnd_50 { magazine = "rhsusf_mag_10Rnd_STD_50BMG_mk211"; count = 3; };
	};
};
