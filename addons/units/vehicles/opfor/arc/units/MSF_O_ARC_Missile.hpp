class MSF_O_ARC_ATRifleman : MSF_O_ARC_Soldier_Base
{
    ...
    scope = 2;
    scopeCurator = 2;
	editorPreview = "z\msf\addons\units\ui\icon\opfor\arc\men\MSF_O_ARC_AARifleman.jpg";
    weapons[] = {
...
class MSF_O_ARC_AARifleman : MSF_O_ARC_Soldier_Base
{
    ...
    scope = 2;
    scopeCurator = 2;
	editorPreview = "z\msf\addons\units\ui\icon\opfor\arc\men\MSF_O_ARC_ATRifleman.jpg";
    weapons[] = {
